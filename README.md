...
<div align="center">
<img src="./assets/contact.png", width=750 />
</div>
...
<div style="display: flex; justify-content: center;">
  <img src="./assets/train_data-Robotics.png" style="width: 120%; height: 150%" />
</div>
...
| RoboBrain-X0-Dataset     | [🤗 BAAI/RoboBrain-X0-Dataset](https://huggingface.co/datasets/BAAI/RoboBrain-X0-Dataset)  | training dataset of RoboBrain-X0                  | 
